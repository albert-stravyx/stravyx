...
import { formatAuMobileDisplay } from "./phone";
import {
  parseVerificationStatus,
  type VerificationStatus,
} from "./casaCredentials";
...
/**
 * Project a profiles row (or missing row) to the client /me shape.
 * Never copies hubspot_contact_id or other CRM fields.
 * Never fabricates CASA validity periods or invented licence numbers.
 */
