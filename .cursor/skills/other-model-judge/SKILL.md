...
Cursor Models (Grok / Composer) explore the repo. Other Models (Claude / GPT / Gemini) only judge a packet.
...
3. If the judge asks for a missing file, **you** (Cursor model) fetch that one file, patch the packet, and relaunch. The judge does not explore.
